...
RUN wget https://github.com/matplotlib/matplotlib/archive/master.zip -O matplotlib.zip  && \
    unzip -q matplotlib.zip && mv /matplotlib_master /matplotlib && cd /matplotlib && \
